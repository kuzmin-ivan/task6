declare const styles: {
  readonly coveredLetter: string;
  readonly mainContentDistinguished: string;
  ...
  readonly isReadMarkNotRead: string;
  readonly dark: string;
  readonly isReadMark: string;
  readonly titleText: string;
  readonly dateInfo: string;
};
export = styles;
